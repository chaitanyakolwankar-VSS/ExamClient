...
const CollegeDetail = () => {
  ...
  const handleImageSelect = (file: File | null, type: "logo" | "banner") => {
    if (!file) return;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!collegeId) {
        ...
        showAlert("success", "Success", "College added successfully");
      } else {
  ...
  return (
    ...
    ${isSaved && isEditting ? "bg-blue-500" : "bg-gray-400 cursor-not-allowed"}`}
      ...
      <div className="flex gap-3 mt-4">
        ...
        {!isSaved && isEditting && <Button onClick={handleSubmit}>Add</Button>}
